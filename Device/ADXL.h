...
extern I2C_HandleTypeDef I2chandler;

#define ADXL_I2C_ADDR     (0x1d)<<1  //SDO/ALT AddRESS=1 Addr=0x1D  =0 Addr=0x53
...
/**
	Data Format Settings 0x31
	DATA_FORMAT[7-0] = SELF_TEST  SPI  INT_INVERT  0  FULL_RES  Justify  Range[2]
	@TODO : SELF_TEST is not implemented yet!
	
	SPI bit:        0 = 4-wire (Default)    API 3/4线选择
			1 = 3-wire
	INT_Invert:     0 = Active High (Default)    中断高低电平     0高电平有效   
                        1 = Active Low                                1低电平有效
	Full Res:	0 = 10-bit (Default)                            
			1 = Full Resolution
	Justify:	0 = Signed (Default)   对齐
			1 = MSB
	Range:						
